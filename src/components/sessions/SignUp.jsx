...
const useStyles = makeStyles((theme) => ({
    ...
    image: {
        backgroundImage: 'url(https://images.unsplash.com/photo-1493827896122-07879ed66323?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2094&q=80)',
